...
██║ ╚═╝ ██║███████║    ██║     ██║  ██║██║  ██║██║ ╚═╝ ██║███████╗██║  ██║
╚═╝     ╚═╝╚══════╝    ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝╚═╝  ╚═╝
        built by @charlesbel upgraded by @farshadz1997      version 2.1.0
</pre>
      ...
      <ul>
        <li>Use optional arguments</li>
          <ul>
            ...
            <li><code>--accounts-file ACCOUNTS_FILE</code> specify a different account.json file path rather than the default.</li>
            <li><code>--alias BOT_NAME</code> Specify the name of the bot when sending logs to Telegram or Discord.</li>
            <li><code>--sms-man TOKEN COUNTRY_ID EXTENSION_NUMBER</code> This argument takes a token, a country id (run get_sms_man_country_id.py to check that) and a conutry extension (+34 for example in Spain) to be able to automatically get SMS codes when required.</li>
            <li>This is my referral link for SMS MAN if you want to support me: <a href="https://sms-man.com/?ref=wwtH1U6ep_vM">SMS MAN</li>
